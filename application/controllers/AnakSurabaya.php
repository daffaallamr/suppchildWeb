...
class AnakSurabaya extends CI_Controller
{
    private $_table = "anak";
    ...
    public function index()
    {
        ...
        $this->load->view('dataAnakDaerah/anakSurabaya', $data);
    ...
    public function hapus($id)
    {
        if ($this->db->delete($this->_table, array("id" => $id))) {
            redirect('anakSurabaya');
        }
    }

    public function detail($id)
    {
        $data['anak'] = $this->AnakSurabaya_model->getAnakById($id);
        $this->load->view('templates/navbar');
    ...
    public function ubah($id)
    {
        ...
        if ($nama == null) {
            ...
            $this->AnakSurabaya_model->ubah($data, 'anak');
            redirect('AnakSurabaya/index');
        }
    }
}

...
class AnakGresik extends CI_Controller
{
    private $_table = "anak";
    ...
    public function index()
    {
        ...
        $this->load->view('dataAnakDaerah/anakGresik', $data);
    ...
    {
        $data['anak'] = $this->AnakGresik_model->getAnakById($id);
        $this->load->view('templates/navbar');
    ...
    public function ubah($id)
    {
        ...
        if ($nama == null) {
            ...
            $this->AnakGresik_model->ubah($data, 'anak');
            redirect('AnakGresik/index');
        }
    }
}

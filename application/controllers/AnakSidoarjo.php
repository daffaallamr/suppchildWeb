...
class AnakSidoarjo extends CI_Controller
{
    private $_table = "anak";
    ...
    public function index()
    {
        ...
        $this->load->view('dataAnakDaerah/anakSidoarjo', $data);
    ...
    public function hapus($id)
    {
        if ($this->db->delete($this->_table, array("id" => $id))) {
            redirect('anakSidoarjo');
        }
    }

    public function detail($id)
    {
        $data['anak'] = $this->AnakSidoarjo_model->getAnakById($id);
        $this->load->view('templates/navbar');
    ...
    public function ubah($id)
    {
        ...
        if ($nama == null) {
            ...
            $this->AnakSidoarjo_model->ubah($data, 'anak');
            redirect('AnakSidoarjo/index');
        }
    }
}

    ...
    <div class="content">
        ...
        <form action="" class="profile">
            <?php foreach ($user as $user) : ?>
                ...
                <input id="nama" type="text" name="nama" class="form_login" value="<?php echo $user['nama_admin'] ?>" readonly>
                <div class="line"></div>
            ...
            <?php endforeach ?>
            <div class="aksi">
                <a href="<?= base_url('profil_edit') ?>" type="submit" name="edit" class="submit">UBAH</a>

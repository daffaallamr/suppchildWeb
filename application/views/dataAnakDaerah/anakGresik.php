        ...
        <table cellspacing='0'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button style="background-color:lightGreen;" ><a style="text-decoration:none;color:white;" href="<?= base_url(); ?>AnakGresik/detail/<?= $a->id; ?>">DETAIL</a></button>
                        <button style="background-color:#fe8f57;"><a style="text-decoration:none;color:white;"href="<?= base_url(); ?>AnakGresik/ubah/<?= $a->id; ?>">UBAH</a></button>
                        ...
                        <div id="isiHapus<?= $a->id; ?>" class="modal">
                            ...
                            <div class="modal-content-hapus">
                                ...
                                <div class="aksi">
                                    <button class="submitButton"><a href="<?= base_url(); ?>anakGresik/hapus/<?= $a->id; ?>">HAPUS</a></button>

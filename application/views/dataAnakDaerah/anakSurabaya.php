            ...
            <table cellspacing='0'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button><a href="<?= base_url(); ?>AnakSurabaya/detail/<?= $a->id; ?>">DETAIL</a></button>
                            <button><a href="<?= base_url(); ?>AnakSurabaya/ubah/<?= $a->id; ?>">UBAH</a></button>
                            ...
                            <div id="isiHapus<?= $a->id; ?>" class="modal">
                                ...
                                <div class="modal-content-hapus">
                                    ...
                                    <div class="aksi">
                                        <button class="submitButton"><a href="<?= base_url(); ?>anakSurabaya/hapus/<?= $a->id; ?>">HAPUS</a></button>

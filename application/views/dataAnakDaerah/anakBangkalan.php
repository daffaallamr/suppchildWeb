        ...
        <table cellspacing='0'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button style="background-color:lightGreen;"><a style="text-decoration:none;color:white;" href="<?= base_url(); ?>AnakBangkalan/detail/<?= $a->id; ?>">DETAIL</a></button>
                        <button style="background-color:#fe8f57;"><a style="text-decoration:none;color:white;" href="<?= base_url(); ?>AnakBangkalan/ubah/<?= $a->id; ?>">UBAH</a></button>

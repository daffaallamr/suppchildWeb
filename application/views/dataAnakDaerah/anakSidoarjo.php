            ...
            <table cellspacing='0'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button><a href="<?= base_url(); ?>AnakSidoarjo/detail/<?= $a->id; ?>">DETAIL</a></button>
                            <button><a href="<?= base_url(); ?>AnakSidoarjo/ubah/<?= $a->id; ?>">UBAH</a></button>
                            <button id="modalHapus<?= $a->id; ?>">HAPUS</button>
                            <!-- MODAL HAPUS User -->
                            <div id="isiHapus<?= $a->id; ?>" class="modal">
                                ...
                                <div class="modal-content-hapus">
                                    ...
                                    <div class="aksi">
                                        <button class="submitButton"><a href="<?= base_url(); ?>anakSidoarjo/hapus/<?= $a->id; ?>">HAPUS</a></button>

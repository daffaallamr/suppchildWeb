    ...
    <div class="content">
        ...
        <form action="" class="profile" method="post">
            <?php foreach ($kasus as $kasus) : ?>
                ...
                <input id="sekarang" type="text" name="nama" class="form_login" value="<?= $kasus['nama']; ?>" readonly>
                <div class="line"></div>

                <label for="baru">Tempat Kejadian</label>
                <input id="baru" type="text" name="tempat" class="form_login" value="<?= $kasus['tempat']; ?>" readonly>
                <div class="line"></div>

                <label for="konfirmasi">Deskripsi Singkat</label>
                <input id="konfirmasi" type="text" name="detail" class="form_login" value="<?= $kasus['detail']; ?>" readonly>
                <div class="line"></div>

                <label for="konfirmasi">Daerah</label>
                <select class="form_login" id="dropDownDaerah" name="daerah" readonly>

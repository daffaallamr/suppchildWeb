...
<head>
    ...
    <div class="content">
        ...
        <form class="profile" method="post" action="<?= base_url('profil_edit_staff') ?>">
                <br>
                <label for="sekarang">Password Sekarang</label>
                <input id="current_password" type="password" name="current_password" class="form_login">
                <div class="line"></div>

                <label for="baru">Password Baru</label>
                <input id="new_password1" type="password" name="new_password" class="form_login">
                <div class="line"></div>

                <label for="konfirmasi">Konfirmasi Password Baru</label>
                <input id="new_password2" type="password" name="repeat_password" class="form_login">
                <div class="line"></div>
